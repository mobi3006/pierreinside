...
>ACHTUNG: Man sollte vermeiden einen DNS-Service in einem Firmennetz mal eben so bereitzustellen. Deshalb BITTE nur für lokale Nutzung konfigurieren (das ist auch die Default-Konfiguration)
