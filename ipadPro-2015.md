...
* auch hier ist die Bedienung für mich nicht immer intuitiv ... wenn man mal unter die Apps schauen will (aufs Filesystem), dann hat man hier keinen so direkten Einstieg. Vielleicht komme ich dazu auch zu sehr aus der Techie-Ecke ... ein typischer Apple-User hat vielleicht einen anderen Blick auf die Apps. Bei der Fehlersuche bzw. Nutzung in nicht direkt vorgesehenen Use-Cases könnte das aber vielleicht helfen
  * Beispiel 1: Mein Hoster verwendet ein Server-Zertifikat für die Mail-Server, das als nicht vertrauenswürdig eingestuft ist. Ich möchte es aber dennoch als vertrausvoll einstufen - auf jedem anderen Betriebssystem (Desktop, Mobil) kann ich einfach dem Zertifikat vertrauen und alles ist gut. Unter iOS 14.2 bekomme ich im 15 Sekundentakt die Meldung "Serverzertifikat wird nicht vertraut" ... das stresst mich voll, da ich nur 15 Sekunden Zeit kabe, um die passenden Einstellungen zu finden und dem Zertifikat explizit zu vertrauen. Irgendwann gebe ich auf und setze mich ans Laptop, um das Problem zu googeln. Was ich dann lese macht mich sprachlos ... ich muß meinen eMail-Account löschen und neu anlegen, denn nur bei Neuanlage kann ich dem Zertifikat explizit vertrauen. Applaus Apple ... das ist ja mal wahnsinning intuitiv, bestätigt mich aber mal wieder darin, daß nicht vorgesehene Use-Cases mit viel Workarounds verbunden sind. Ich fühle mich hier echt verarscht ... grundsätzlich mag ich keine User-Interfaces, die mich in meiner Freiheit einschränken wollen.
  * Beispiel 2: ich wollte meine [DrawExpress-Zeichnungen](http://drawexpress.com/) importieren. Die Import-Funktionalität in der App habe ich nicht gefunden. Deshalb wollte ich die Zeichnungsdateien einfach ins Filesystem ablegen. Doch dort finde ich nur die Verzeichnisse *Downloads* und *User Manual*
